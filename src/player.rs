...
pub fn move_player(constructor: &mut GlobalVariable) {
    ...
    constructor.player.dir_vector.0 = -(keyboard_state.is_scancode_pressed(Scancode::A) as i8)
    ...
    constructor.player.dir_vector.1 = -(keyboard_state.is_scancode_pressed(Scancode::W) as i8)
